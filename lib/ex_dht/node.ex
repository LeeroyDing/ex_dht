defmodule ExDHT.Node do
  ...
  @spec get_trans(pid()) :: list(bitstring())
  def get_trans(node) do
    GenServer.call node, :get_trans
  end
  ...
  @spec update_access(pid(), integer | nil) :: :ok | :error
  ...
  def handle_call(:get_trans, _from, state) do
    {:reply, state.trans, state}
  end
  ...
  def handle_call({:update_access, access_time}, _from, state) do
    {:reply, :ok, %{state | access_time: access_time}}
  end
